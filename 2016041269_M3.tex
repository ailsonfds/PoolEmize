...
\markright{}
\addcontentsline{toc}{subsection}{Visualizar pontuações de usuários - Ranker}
...
\markright{}
\addcontentsline{toc}{subsection}{Gerenciar enquete/eleição - Survey}
\includegraphics[width=14.3cm]{statemachine_diagrams/SurveyStatemachineDiagram.png}

\section*{DdAs}
\markright{}
\addcontentsline{toc}{section}{DdAs}
\subsection*{Criar conta}
\markright{}
\addcontentsline{toc}{subsection}{Criar conta}
...
\markright{}
\addcontentsline{toc}{subsection}{Visualizar enquete/eleição}
...
\markright{}
\addcontentsline{toc}{section}{Diagrama de classes detalhado}
